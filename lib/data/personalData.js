export const PersonalData={
    ...
    skill:["Javascript","Python","NodeJs","ReactJs","NextJs","Zustand","ExpressJs","MongoDB","Docker"],
    typerData:["Software Developer", "React Developer", "Next Developer","Freelancer"],
