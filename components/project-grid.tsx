                ...
                <div className="flex justify-between items-start p-4">
                  ...
                  <div>  
                    <motion.a
                      ...
                      href={active.code}
                      target="_blank"
                      className="px-4 mr-2 py-3 text-sm rounded-full font-bold bg-green-500 text-white"
                    >
                      Repo
                    </motion.a>
                    <motion.a
            ...
            <div className="flex gap-4 flex-col  w-full">
              ...
              <div className="flex flex-col">
                <motion.div
                  ...
                  className="font-medium text-xl text-neutral-800 dark:text-neutral-200 text-start md:text-left"
                >
                  {project.name}
                </motion.div>
                <motion.p
