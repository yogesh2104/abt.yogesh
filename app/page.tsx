        ...
        <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
          <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
            <h1 className="text-2xl font-bold leading-10 text-black dark:text-white md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem] text-left">
              Hello, <br />
              This is {' '}
              <span className=" text-[#2c73e4]">{PersonalData.name}</span>
              {` , I'm a Professional `}
            ...
            <div className="flex items-center gap-3">
              <Link href="/contact-us">
                <Button variant="outline" className="h-10 dark:border-white border-black text-xs rounded-lg text-center md:text-sm font-medium uppercase tracking-wider no-underline transition-all duration-200 ease-out  md:font-semibold flex items-center gap-1 hover:gap-3">
